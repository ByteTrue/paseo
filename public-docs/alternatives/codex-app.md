...
description: Paseo is an open source alternative to Codex App for developers who want Linux, mobile web/PWA, a self-hosted daemon, and Codex alongside Claude Code, OpenCode, Copilot, and more.
nav: Codex App
order: 105
---
...
Paseo runs a daemon on your machine. Desktop, web/PWA, and CLI clients connect to it over a websocket. The daemon launches Codex and other providers as local processes, using your installed CLIs and credentials.
