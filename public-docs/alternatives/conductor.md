---
title: Open Source Conductor Alternative With Linux, Windows, and Browser Access
description: Paseo is open source, runs on macOS, Linux, and Windows, offers browser access from anywhere, and supports 30+ agents through the in-app catalog plus any ACP or CLI agent. Conductor is macOS only and Claude Code or Codex only.
nav: Conductor
order: 100
---
...
The Paseo daemon runs as its own process. Desktop, web, and CLI all connect to it over a websocket. Run the daemon on your laptop, on a VM, in Docker, or across a fleet, and connect to any of them from any client.
...
Paseo gives you a web app you can use from your phone browser. Conductor has no phone client.
...
| Phone access                 | Web app in browser                                              | —                  |
