...
- `bt-tracker` — external tracker bridge：把 confirmed ByteTrue 产物 publish/link/update 到 GitHub/GitLab/local tracker，或 triage 外部 incoming issues；不替代 `bt-roadmap` / `bt-feat` / `bt-issue`
