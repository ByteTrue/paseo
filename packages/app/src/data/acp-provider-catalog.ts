...
const CATALOG_DATA = [
  ...
  },
  {
    ...
    command: ["npx", "-y", "@tencent-ai/codebuddy-code@2.103.1", "--acp"],
  },
  {
    id: "codex-acp",
    title: "Codex CLI",
  ...
  },
  {
    ...
    command: ["npx", "-y", "droid@0.141.0", "exec", "--output-format", "acp-daemon"],
    env: {
  ...
  },
  {
    ...
    command: ["npx", "-y", "@google/gemini-cli@0.45.1", "--acp"],
  },
  {
