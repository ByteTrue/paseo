...
Distribution: native apps for Mac, Windows, Linux, and Android; web app; Homebrew; npm. iOS can be built locally with a personal Apple ID. Source: AGPL-3.0 at https://github.com/ByteTrue/paseo. Marketing site: https://paseo-website.bytetrue.workers.dev.
`;
...
- [Download](${SITE_URL}/download): Install Paseo on Mac, Windows, Linux, Android, or run the web app.
