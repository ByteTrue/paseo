...
> Web and desktop app for monitoring and controlling your local AI coding agents from anywhere.
...
A self-hosted daemon manages agent lifecycle, exposes a WebSocket API, and ships with an MCP server so other agents can talk to it. Desktop apps for macOS, Windows, and Linux plus the web app let you launch sessions, watch them work, review diffs, and ship from anywhere. A Docker-style CLI ("paseo run", "paseo ls", "paseo logs", "paseo wait") gives you scripting access. An end-to-end encrypted relay lets the web app reach your daemon over the public internet without exposing it.
...
Distribution: desktop apps for Mac, Windows, and Linux; web app; Homebrew; npm. Source: AGPL-3.0 at https://github.com/ByteTrue/paseo. Marketing site: https://paseo-website.bytetrue.workers.dev.
`;
...
- [Changelog](${SITE_URL}/changelog): Release notes for the Paseo daemon, CLI, desktop, and web app.
