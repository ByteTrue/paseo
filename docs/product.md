...
Paseo is a next-generation development environment built around agents. One interface to run, monitor, and interact with coding agents across desktop, mobile web, terminal, and web.
...
- **Cross-device** — Desktop, mobile web/PWA, web, CLI. Start work at your desk, check progress from your phone browser, script from the terminal.
...
- Desktop (Electron), mobile web (PWA), browser web, CLI. Separate mobile-store clients are not official release surfaces.
